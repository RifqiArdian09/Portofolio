...
• Alur Pemilihan Intuitif: Antarmuka ringkas (Verifikasi -> Surat Suara -> Konfirmasi) untuk kemudahan penggunaan.`,
    ...
    },
    {
        ...
        date: "2026",
        content: `Platform profil digital resmi milik Unit Pelaksana Teknis Teknologi Informasi dan Komunikasi (UPTIK) Universitas Muhammadiyah Bengkulu. Proyek ini bertujuan untuk menyediakan pusat informasi terpadu yang profesional mengenai identitas instansi, layanan teknologi, dan pencapaian digital di lingkungan kampus.

Detail Implementasi:

1. Konsep & Tujuan:
• Transformasi Digital: Digitalisasi profil instansi untuk kemudahan akses informasi bagi stakeholder.
...
3. Fitur Utama:
• Katalog Layanan IT: Informasi lengkap mengenai infrastruktur dan support teknis.
• News & Updates: Sistem publikasi kegiatan dan berita terkini seputar teknologi kampus.
• Responsive Design: Optimal untuk berbagai perangkat guna menjangkau audiens secara luas.`,
    },
    {
        id: "cms-fakultas",
        ...
        date: "2025",
        content: `CMS Fakultas UMB adalah platform Content Management System (CMS) modern yang dirancang khusus untuk digitalisasi informasi pada lingkup fakultas di Universitas Muhammadiyah Bengkulu. Platform ini mempermudah admin fakultas dalam mengelola konten akademik dan informasi publik secara mandiri.

Detail Implementasi:

1. Latar Belakang & Solusi:
• Efisiensi Kelola Data: Menggantikan sistem manual dengan panel kontrol yang intuitif.
• Standarisasi Informasi: Memastikan format penyampaian informasi seragam antar fakultas.
...
• Global State Management: Pengelolaan state aplikasi untuk fitur riwayat tontonan dan navigasi yang cepat.`,
    },
    {
        ...
        description:
            "Platform landing page interaktif and modern untuk mempermudah calon mahasiswa dalam mengakses informasi pendaftaran di Universitas Muhammadiyah Bengkulu.",
