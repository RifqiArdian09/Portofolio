      ...
      <div ref={shellRef} className="relative z-[1] group">
        ...
        >
          ...
          >
            ...
            {/* Glare layer */}
            {showGlare && <div style={glareStyle} />}
            ...
            >
              <img
                className="w-full h-full absolute inset-0 object-cover will-change-transform transition-transform duration-[120ms] ease-out"
                src={avatarUrl}
                ...
                style={{
                  ...
                  transform:
                    'translateX(calc((var(--pointer-from-left) - 0.5) * 10px)) translateY(calc((var(--pointer-from-top) - 0.5) * 10px)) translateZ(0) scale(1.05)',
                  borderRadius: cardRadius,
                  backfaceVisibility: 'hidden'
                }}
                onError={e => {
              ...
              <div
                className="absolute inset-x-0 top-0 h-1/3 opacity-60 pointer-events-none"
                style={{
              ...
              <div className="w-full absolute flex flex-col" style={{ top: '3em', display: 'flex', gridArea: 'auto' }}>
                ...
                <p
                  ...
                  style={{
                    ...
                    fontSize: '16px',
                    margin: '0 auto',
                    backgroundImage: 'linear-gradient(to bottom, #fff 20%, #4a4ac0 100%)',
                    backgroundSize: '1em 1.5em',
                    WebkitTextFillColor: 'transparent',
                    backgroundClip: 'text',
                    WebkitBackgroundClip: 'text',
